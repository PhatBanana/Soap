...
export const OILS = {
  ...
  almond:     { name:"Sweet almond oil", allergen:"treenut",  sap:.136,  iod:99,  ins:97,  fa:{la:0, my:0, pa:7, st:2, ri:0, ol:71,li:18,ln:0},
  ...
  argan:      { name:"Argan oil", allergen:"treenut",         sap:.136,  iod:95,  ins:95,  fa:{la:0, my:0, pa:12,st:6, ri:0, ol:45,li:35,ln:0},
                desc:"Prized skincare oil — very conditioning and light. Pricey, so it shines as a small superfat luxury. Typical 3–10%." },
  macadamia:  { name:"Macadamia oil", allergen:"treenut",     sap:.139,  iod:76,  ins:119, fa:{pa:8, st:3, ar:2, po:20,ol:58,li:2, ga:2},
  ...
  sesame:     { name:"Sesame oil", allergen:"sesame",        sap:.133,  iod:108, ins:81,  fa:{la:0, my:0, pa:10,st:5, ri:0, ol:40,li:45,ln:0},
  ...
  soybean:    { name:"Soybean oil", allergen:"soy",       sap:.135,  iod:130, ins:61,  fa:{pa:11,st:4, ar:1, ol:23,li:54,ln:7},
  ...
  peanut:     { name:"Peanut oil", allergen:"peanut",        sap:.136,  iod:92,  ins:99,  fa:{pa:11,st:3, ar:6, ol:48,li:32},
  ...
  vegoil:     { name:"Vegetable oil (soybean)", allergen:"soy",sap:.135,  iod:130, ins:61,  fa:{pa:11,st:4, ar:1, ol:23,li:54,ln:7},
  ...
  walnut:     { name:"Walnut oil", allergen:"treenut",             sap:.1353, iod:145, ins:45,  fa:{la:0, my:0, pa:7, st:2, ri:0, ol:18,li:60,ln:11},
  ...
  wheatgerm:  { name:"Wheat germ oil", allergen:"gluten",         sap:.131,  iod:128, ins:58,  fa:{pa:16,st:1, ar:2, ol:15,li:55,ln:7},
  ...
  mustard:    { name:"Mustard oil", allergen:"mustard",        sap:.1235, iod:106, ins:67,  fa:{pa:2, st:1, ol:14,li:15,ln:9, ga:56},
  ...
  lanolin:    { name:"Lanolin", allergen:"wool",            sap:.076,  iod:28,  ins:82,  fa:{pa:6, st:3, ar:32,po:2, ol:24,li:2, ga:26},
  ...
  soywax:     { name:"Soy wax (hydrogenated soybean)", allergen:"soy", sap:.1373, iod:5, ins:180, fa:{pa:11,st:85,ar:2},
